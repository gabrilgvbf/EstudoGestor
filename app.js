...
materiasData = [
  ...
  { nome: 'CONHECIMENTOS BANCÁRIOS', peso: 2, topicos: [ 'Estrutura do Sistema Financeiro Nacional', 'Órgãos normativos, supervisoras, executoras e operadoras', 'Mercado financeiro: visão geral', 'Mercado monetário', 'Mercado de crédito', 'Mercado de capitais', 'Mercado cambial', 'Moeda: conceitos e funções', 'Política monetária convencional', 'Políticas monetárias não-convencionais (Quantitative Easing etc.)', 'Taxa SELIC e sua operação', 'Operações compromissadas', 'Depósitos remunerados de bancos comerciais no Banco Central do Brasil', 'Orçamento público: conceitos e relações com o mercado', 'Títulos do Tesouro Nacional', 'Dívida pública: composição e gestão', 'Produtos bancários: cartões de crédito e débito', 'Produtos bancários: crédito direto ao consumidor (CDC) e crédito rural', 'Produtos bancários: poupança, capitalização e previdência', 'Produtos bancários: consórcio, investimentos e seguros', 'Noções do mercado de capitais (ações, debêntures, fundos, bolsas)', 'Noções do mercado de câmbio: instituições autorizadas e operações básicas', 'Regimes cambiais: fixo, flutuante e intermediários', 'Taxas de câmbio nominais e reais', 'Impacto das taxas de câmbio em exportações e importações', 'Diferencial de juros interno vs. externo, prêmios de risco e fluxo de capitais', 'Dinâmica do mercado: operações no mercado interbancário', 'Mercado bancário: operações de tesouraria', 'Mercado bancário: varejo bancário e recuperação de crédito', 'Taxas de juros de curto prazo e a curva de juros', 'Taxas de juros nominais e reais', 'Garantias no SFN: aval, fiança e penhor mercantil', 'Garantias no SFN: alienação fiduciária, hipoteca e fianças bancárias', 'Crime de lavagem de dinheiro: conceito e etapas', 'Prevenção e combate à lavagem de dinheiro: Lei nº 9.613/98 e alterações', 'Normativos relevantes: Circular nº 3.978/2020 e Carta Circular nº 4.001/2020', 'Autorregulação bancária e Normativos SARB', 'Sigilo bancário: Lei Complementar nº 105/2001 e alterações', 'LGPD: Lei nº 13.709/2018 e impactos no setor financeiro', 'Legislação anticorrupção: Lei nº 12.846/2013 e Decreto nº 11.129/2022', 'Segurança cibernética: Resolução CMN nº 4.893/2021', 'Ética aplicada: ética, moral, valores e virtudes', 'Ética empresarial e profissional; gestão da ética em empresas públicas e privadas', 'Código de Ética do Banco do Brasil (consulta ao sítio do BB)', 'Política de Responsabilidade Socioambiental do Banco do Brasil (consulta ao sítio do BB)', 'ASG (Ambiental, Social e Governança): conceitos e práticas', 'Economia sustentável e financiamentos ASG', 'Mercado PJ e produtos voltados a empresas' ]},
